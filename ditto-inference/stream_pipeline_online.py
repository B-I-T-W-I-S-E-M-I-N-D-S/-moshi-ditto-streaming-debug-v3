...
class StreamSDK:
    def __init__(self, cfg_pkl, data_root, **kwargs):
        ...
        if torch.cuda.is_available():
            ...
            print(f"StreamSDK initializing on device: {self.device}")
    ...
    def _set_device_wrapper(self, func):
        def wrapper():
            import torch
            if torch.cuda.is_available() and hasattr(self, 'device_id'):
                torch.cuda.set_device(self.device_id)
            return func()
        return wrapper
    ...
    def writer_worker(self):
        try:
            self._set_device_wrapper(self._writer_worker)()
        except Exception as e:
    ...
    def putback_worker(self):
        try:
            self._set_device_wrapper(self._putback_worker)()
        except Exception as e:
            self.worker_exception = e
            self.stop_event.set()
    ...
    def decode_f3d_worker(self):
        try:
            self._set_device_wrapper(self._decode_f3d_worker)()
        except Exception as e:
            self.worker_exception = e
            self.stop_event.set()
    ...
    def warp_f3d_worker(self):
        try:
            self._set_device_wrapper(self._warp_f3d_worker)()
        except Exception as e:
            self.worker_exception = e
            self.stop_event.set()
    ...
    def motion_stitch_worker(self):
        try:
            self._set_device_wrapper(self._motion_stitch_worker)()
        except Exception as e:
            self.worker_exception = e
            self.stop_event.set()
    ...
    def audio2motion_worker(self):
        try:
            self._set_device_wrapper(self._audio2motion_worker)()
        except Exception as e:
            self.worker_exception = e
            self.stop_event.set()
